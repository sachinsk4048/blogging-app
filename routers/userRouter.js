...
const { authMiddleware, accessRole,isbanned } = require('../middlewares/authMiddleware');
...
userRouter.post('/post/:id/like', authMiddleware,isbanned,userController.postLikePost);
userRouter.post('/post/:id/unlike', authMiddleware, userController.postUnlikePost);
userRouter.post('/post/:id/comment', authMiddleware,isbanned,validate(commentSchema), userController.postComment);
...
userRouter.post('/user/createPost', authMiddleware,isbanned,validate(createPostSchema), userController.postCreatePost);
